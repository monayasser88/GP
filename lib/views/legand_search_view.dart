...
class LegendSearchView extends StatefulWidget {
  const LegendSearchView({Key? key}) : super(key: key);

  @override
  State<LegendSearchView> createState() => _LegendSearchViewState();
}

class _LegendSearchViewState extends State<LegendSearchView> {
